...
// create your own at http://www.quinapalus.com/hd44780udg.html
var CustomLCDChars = map[string][8]byte{
	...
	"equals":        [8]byte{0, 0, 0, 31, 0, 31, 0, 0},
	"up_arrow":      [8]byte{4, 14, 31, 4, 4, 4, 4, 4},
	"down_arrow":    [8]byte{4, 4, 4, 4, 4, 31, 14, 4},
	"left_pointer":  [8]byte{0, 0, 2, 6, 14, 6, 2, 0},
	"right_pointer": [8]byte{0, 0, 8, 12, 14, 12, 8, 0},
	"noise":         [8]byte{10, 21, 10, 21, 10, 21, 10, 21},
}
